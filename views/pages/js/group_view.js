...
AE.widget.groupViewer = (function() {
	var YUD = GASGOO.util.Dom, YUE = GASGOO.util.Event ;
	...
	var dropAnim = function(panel) {
		...
		var anim = new GASGOO.util.Anim(panel, { height: {from: 0, to: panel.dropHeight} }, 0.3);
...
var closeAll = function(){
	...
	var drawAnim = new GASGOO.util.Anim(curRel, { height: { to: 0} }, 0.2);
	...
	var drop = function() {
		...
		if (currentHook) {
			...
			if (this.parentNode.parentNode != currentHook.parentNode.parentNode) {
				var hiddenAnim = new GASGOO.util.Anim(curRel, { height: { to: 0} }, 0.15);
				var cp = currentHook;
